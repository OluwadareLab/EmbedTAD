...
overall, n_4, n_8, n_12, n_16, n_20 = read_data("/home/mohit/Documents/project/tad/codebase/analysis_results/qc/netmf/tad_quality.csv")
...
for ax, data, title in zip(axes.flat, [overall, n_4, n_8, n_12, n_16, n_20], titles):
    bars = sns.lineplot(data=data, x="Embedding Size", y="TQ (CT)", color=next(palette), linewidth=4,  ax=ax)
...
plt.savefig("tad_quality_lineplots.png", dpi=300, bbox_inches="tight")
